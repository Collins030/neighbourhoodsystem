<?php
// create_events.php - Enhanced Event creation with map integration
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($event_date) || empty($location)) {
        ...
        try {
            ...
            // Check if events table has latitude/longitude columns, add them if not
            ...
            $stmt = $pdo->prepare("
                INSERT INTO events (user_id, title, description, event_date, end_date, location, address, max_attendees, latitude, longitude)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ");
...
<body>
            ...
            <div class="map-container">
                <div class="map-section">
                    ...
                    <div class="map-instructions">
                        ...
                        • Location details will auto-fill in the form
                    </div>
    ...
    <script>
        ...
        function searchAddress() {
            ...
            // Use a simple geocoding service (you might want to use a more robust one)
