...
<body>
    ...
    <div class="container">
        ...
        <button class="feature-btn" onclick="window.location.href='create_events.php'">Create Event</button>             
    </div>             
    <div class="feature-card">                 
        <h3>🔍 Browse Events</h3>                 
        <p>Discover what's happening in your neighbourhood. Join events, meet new people, and get involved in your community.</p>                 
        <button class="feature-btn" onclick="window.location.href='browse_events.php'">Browse Events</button>             
    </div>             
    <div class="feature-card">                 
        <h3>💬 Community Chat</h3>                 
        <p>Connect with your neighbours through our community chat feature. Share updates, ask questions, and stay informed.</p>                 
        <button class="feature-btn" onclick="window.location.href='community_chat.php'">Join Chat</button>             
    </div>             
    <div class="feature-card">                 
        ...
        <button class="feature-btn" onclick="window.location.href='neighbourhood_map.php'">View Map</button>             
    </div>         
</div>            
